...
- PR #34 리뷰 반영: 탭 라벨 매핑 단순화, 카드 semantics 중복 제거, 외부 Scaffold 인셋 소비
- 서재 UI 보정: 카드 배경 제거, 고정 3열 배치, 책이 있을 때만 추가 버튼 노출
...
1. V7 공유 집계 PR과 V5 서재 정렬 PR을 시작해 V6의 남은 의존성을 먼저 해소한다.
2. V1·V2·V3·V4는 서로 독립적으로 시작할 수 있다.
