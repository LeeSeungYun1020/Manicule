...
| V6 | 홈 | V5 서재 조회 계약; V7 공유 집계 | 🚧 서재 초기 탭 진입 계약 구현 완료·리뷰/머지 대기 | 현재 PR 머지 후 홈 상태 조합·첫 사용자 화면 |
...
1. V6 선행 PR인 서재 초기 탭 진입 계약을 리뷰·머지한다. 다음 구현은 최신 `main`에서 홈 상태 조합·첫 사용자 화면 PR만 진행한다. V5 정렬과 V7 UI 완료는 기다리지 않는다.
