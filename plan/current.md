...
| V5 | 서재 | 상태 변경은 V4 상태 API | 🚧 상태별 목록·빈 상태·책 상세/검색/스캔 이동·정렬, 진행률/완독일 오버레이 완료 | 롱프레스 상태 변경·삭제·Undo |
...
1. V5 다음 PR로 롱프레스 메뉴(상태 변경·삭제) 및 Undo를 구현한다. V4 독서 상태 변경 API를 재사용한다.
