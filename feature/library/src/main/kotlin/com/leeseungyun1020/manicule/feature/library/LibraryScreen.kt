...
private fun EmptyLibrary(
    ...
    Box(
        ...
        ManiculeEmptyState(
            ...
            actions = {
                ManiculeButton(onClick = onSearch, text = stringResource(R.string.library_search))
                ManiculeOutlinedButton(onClick = onScan, text = stringResource(R.string.library_scan))
            },
        )
    }
}
